...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'elastik:migrate:statistics {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Migrate Elastik Statistics Tables.';
